...
ALTER TABLE RESERVATION ADD CONSTRAINT FK_ROOM_TO_RESERVATION 
	FOREIGN KEY (ROOM_NO) REFERENCES ROOM (ROOM_NO)
		ON DELETE CASCADE;

ALTER TABLE ROOM ADD CONSTRAINT FK_ROOM_TYPE_TO_ROOM
	FOREIGN KEY (RT_NO)	REFERENCES ROOM_TYPE (RT_NO)
		ON DELETE CASCADE;

ALTER TABLE IMAGE ADD CONSTRAINT FK_ROOM_TO_IMAGE
	FOREIGN KEY (ROOM_NO) REFERENCES ROOM (ROOM_NO)
		ON DELETE CASCADE;
